...
You can generate this metric by marking the [lynx pipeline](/guide/spec#lynx-pipeline) that contains important elements with [`__lynx_timing_flag="__lynx_timing_actual_fmp"`](/guide/performance/metrics/timing-flag).
