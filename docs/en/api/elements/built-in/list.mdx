...
`border-radius related CSS properties` includes: [border-radius](api/css/properties/border-radius.mdx), [border-bottom-left-radius](api/css/properties/border-bottom-left-radius.mdx), [border-bottom-right-radius](api/css/properties/border-bottom-right-radius.mdx).

### list-item

<LegacyCompatTable metadata="elements/list-item" />

`position related CSS properties` includes: [position](api/css/properties/position.mdx), [left](api/css/properties/left.mdx), [top](api/css/properties/top.mdx), [right](api/css/properties/right.mdx), [bottom](api/css/properties/bottom.mdx).
