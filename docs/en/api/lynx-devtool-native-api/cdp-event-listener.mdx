...
A **protocol (or interface)** used to receive [CDP](https://chromedevtools.github.io/devtools-protocol/) **Event** messages sent by DevTool.
...
| :----- | :----- | :------------------------------------------------------------------------------------------- |
| method | string | Event name, please refer to [CDP](https://chromedevtools.github.io/devtools-protocol/)       |
| params | object | Event parameters, please refer to [CDP](https://chromedevtools.github.io/devtools-protocol/) |

For example, the data for [`Page.screencastFrame`](https://chromedevtools.github.io/devtools-protocol/tot/Page/#event-screencastFrame) is as follows:
...
1. [Implement `CDPEventListener`](#syntax).
...
3. Call the [`addCDPEventListener`](/api/lynx-devtool-native-api/lynx-base-inspector-owner/add-cdp-event-listener) method to add the message listener.
