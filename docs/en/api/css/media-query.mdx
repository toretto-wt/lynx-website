...
`enableCSSRule` requires Lynx SDK 4.0 or later. Without it, `@media` rules are not encoded into the template and do not take effect at runtime.

## Example

This example evaluates media queries for portrait viewport width, height, and pixel density.
