...
- `<list>` [paginated scrolling](en/api/elements/built-in/list.html#implementing-paginated-scrolling)

- `<list>` [load more](en/api/elements/built-in/list.html#implementing-load-more)
