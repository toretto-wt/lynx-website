...
- `<list>` [paginated scrolling](api/elements/built-in/list.html#implementing-paginated-scrolling)

- `<list>` [load more](api/elements/built-in/list.html#implementing-load-more)
