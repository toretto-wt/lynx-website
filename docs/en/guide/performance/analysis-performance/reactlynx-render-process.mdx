...
[First-frame Rendering](/guide/spec.html#first-frame-rendering) includes stages such as downloading the [Bundle](/guide/spec.html#lynx-bundle-or-bundle), loading the bundle, and drawing.
