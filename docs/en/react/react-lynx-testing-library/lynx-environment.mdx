...
<Details title="@lynx-js/react-lynx-testing-library already includes @lynx-js/lynx-environment">
If you want to run unit testing in ReactLynx, @lynx-js/react-lynx-testing-library already includes @lynx-js/lynx-environment, so you don't need to specify this configuration manually.

Please refer to [ReactLynx Testing Library](/en/react/react-lynx-testing-library/index) to setup the configuration for `@lynx-js/react-lynx-testing-library`.
