...
**Extra Topics**: Consult the [API Reference](/api/react/index) and use [Framework Performance Profiling](/guide/performance/analysis-performance/analysis-framework) to investigate performance issues.
