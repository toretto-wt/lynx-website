...
These best practices are also available as an [Agent Skill](https://github.com/lynx-community/skills) for your coding agents. Install with `npx skills add lynx-community/skills` to get automated detection and auto-fix in your editor.
:::
