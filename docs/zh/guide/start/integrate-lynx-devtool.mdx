...
你可以在[初始化 LynxEnv](/guide/start/integrate-with-existing-apps.html#lynxenv-初始化) 时打开设置这些开关：

<Tabs groupId='integrating-lynx-with-existing-app-ios'>
<Tab label="Objective-C">

```objective-c title=AppDelegate.m {7-13}
...
```swift title=AppDelegate.swift {5-11}
...
:::info
除了前面介绍的开关外，还有更多开关可以帮助你控制 DevTool 的行为，请参考 [Lynx DevTool 开关页面](/guide/start/integrate-lynx-devtool-advanced.html#debugging-devtool-switch)。
:::
...
```java title=YourApplication.java {3-6}
...
```kotlin title=YourApplication.kt {3-6}
...
:::info
除了前面介绍的开关外，还有更多可以帮助你控制 DevTool 的行为，请参考 [DevTool 开关页面](/guide/start/integrate-lynx-devtool-advanced.html#debugging-devtool-switch)。
:::
