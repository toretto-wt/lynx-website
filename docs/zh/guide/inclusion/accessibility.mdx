...
使用 [`accessibilityAnnounce`](/api/lynx-api/lynx/lynx-accessibility-announce#lynx-accessibilityannounce-static-method) 让屏幕阅读器朗读指定的文本内容，帮助视觉障碍用户感知界面状态变化或操作结果。
