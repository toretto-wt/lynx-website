...
<Details title="@lynx-js/react-lynx-testing-library 中已经包含了 @lynx-js/lynx-environment">
如果你想在 ReactLynx 中进行单元测试，@lynx-js/react-lynx-testing-library 中已经包含了 @lynx-js/lynx-environment，因此你不需要手动指定此配置。

请参考 [ReactLynx Testing Library](/zh/react/react-lynx-testing-library/index) 对 `@lynx-js/react-lynx-testing-library` 进行配置。
