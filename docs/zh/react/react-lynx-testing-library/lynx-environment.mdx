...
<Details title="@lynx-js/react/testing-library 中已经包含了 @lynx-js/lynx-environment">
如果你想在 ReactLynx 中进行单元测试，@lynx-js/react/testing-library 中已经包含了 @lynx-js/lynx-environment，因此你不需要手动指定此配置。
